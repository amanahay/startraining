...
const router = createRouter({
  ...
  routes: [
    ...
    { path: '/request-konsultasi', component: () => import('./views/ConsultationView.vue') },
    { path: '/klien', component: () => import('./views/ClientsView.vue') },
    { path: '/event', component: () => import('./views/EventsView.vue') },
    { path: '/event/:slug', component: () => import('./views/EventDetailView.vue') },
    { path: '/proposal/:slug', component: () => import('./views/ProposalView.vue') },
